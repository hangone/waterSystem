...
const Example = () => {
  ...
  const dam2 = `
  <div>
    <b><font color="blue">黄地水电站</font></b>
  </div>
  <p style="margin-top: 10px;">
  地理位置
  东经115°30'28"
  ...
  const dam3 = `
  <div>
    <b><font color="blue">雲山水电站</font></b>
  </div>
  <p style="margin-top: 10px;">
  地理位置：
  东经115°31′10″
  ...
  <p style="margin-top: 10px;">
  黄沙水电站是一座以发电为主，结合防洪、养殖等综合利用的小型水利枢纽工程。该电站也是大脑河流域梯级开发的二级水电站。枢纽主要建筑物由大坝、发电引水系统和电站厂房组成。
