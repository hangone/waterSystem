...
import {  AppstoreOutlined, MenuUnfoldOutlined,  MenuFoldOutlined,  PieChartOutlined,  
  BranchesOutlined , SlackOutlined, AimOutlined,
  DownCircleOutlined,UpCircleOutlined, MessageOutlined, TagsOutlined  } from '@ant-design/icons';
import './index.css';
...
function Home(props){
    ...
    useEffect(()=>{
        ...
        window.addEventListener('message', function(e) {
            ...
            if(e.data.length > 80 && e.data.startsWith("ey")  && e.data.includes(".")){ 
            ...
            <div className='home-div'>
                <div className={'left-div' + (collapsed ? ' hidden' : '')} >
                    ...
                    <Menu openKeys={defaultSidebarMenu} selectedKeys={defaultSidebarItem} 
                        ...
                        <SubMenu key="homePage" icon={<AppstoreOutlined />} title="基础功能"  onClick={onSelect} > 
                    ...
                    {
                         isHaveAuth
                        ?<div id='fix-data' className='float-tag-div' title="数据修正" onClick={()=>changeData()}>
                            <AimOutlined />
                        </div> 
                        :''
                    }  
                ...
                <div className='content-div'>
                    ...
                    <div className='header-div'>
                        <div className='header-left'> 
                            ...
                            <div className='useable-div' onClick={handleBigPage}>监控大屏</div>
                            <div className='useable-div' onClick={handleHelp}>使用帮助</div>
                            {
                                isShowTitleText
                                ?<div className='useable-div showmore-div' onClick={handleAddMenu}>
                                    <span>更多选项</span>
                                    {
                                        isShowTitleMenu 
                                        ?<UpCircleOutlined />
