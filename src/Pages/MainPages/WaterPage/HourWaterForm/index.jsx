...
function DayWaterForm() {
  ...
  const onSearchTable = (e, initData = null) => {
    ...
    getHourWaterForm(paramsObj)
      .then((res) => {
        ...
        let t_dataResource = Tools.handleHourWaterTableDataY(
          typeList,
          res,
          31,
          10,
  ...
  const handleOutput = (mode) => {
    ...
    const excelFileName = `山口岩水库分时水位明细报表(${searchTxtObj.startTime.slice(
      0,
      4
    )})`
